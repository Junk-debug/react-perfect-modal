export default function DashedPlaceholder() {
  return (
    <div className="relative aspect-square overflow-hidden rounded-xl border border-dashed border-gray-400 opacity-75">
      <svg
